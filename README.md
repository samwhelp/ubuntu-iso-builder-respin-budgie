...
# ubuntu-iso-builder-respin-budgie
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-budgie](https://samwhelp.github.io/ubuntu-iso-builder-remix-budgie/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-budgie) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-budgie](https://samwhelp.github.io/ubuntu-iso-builder-respin-budgie/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-budgie](https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-budgie.git
```


> change dir to `ubuntu-iso-builder-respin-budgie`

``` sh
cd ubuntu-iso-builder-respin-budgie
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-budgie/dist`
